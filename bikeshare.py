...
def get_filters():
    """
    asking the client to chooose the city, month, and day to analyze.
    Returns:
        (str) city - name of the city to analyze
        (str) month - name of the month to filter by, or "all" in case of no month
        (str) day - name of the day of week to filter by, or "all" in case of no day
    """
    print('Hello! Let\'s explore some US bikeshare data!')
     
    while True:
        city=input('Select a city from Chicago, New York and Washington. \n').lower()
    ...
    while True:
        month=input('Do you want a specific month to analyze? If yes, then type out the month. If not, type in all\n').lower()
    ...
    while True:
        day=input('Do you want to filter by day? If yes, then type out the day. If not, type in all\n').lower()
        if day not in days:
